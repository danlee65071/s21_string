...
SRC = s21_memcmp.c s21_memchr.c s21_memset.c s21_strlen.c s21_strncat.c s21_strncmp.c s21_strncpy.c s21_memcpy.c s21_strrchr.c s21_strchr.c s21_strpbrk.c s21_trim.c
...
SRC_TESTS = unit_tests.c s21_memcmp_test.c s21_memchr_test.c s21_memset_test.c s21_strlen_test.c s21_strncat_test.c s21_strncmp_test.c s21_strncpy_test.c s21_memcpy_test.c s21_strrchr_test.c s21_strchr_test.c s21_strpbrk_test.c s21_trim_test.c
